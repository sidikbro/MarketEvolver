...
def _entities(observed_at: datetime) -> tuple[EntityVersion, ...]:
    entities = [
        ...
        _entity(
            ...
            KnowledgeEntityType.GOVERNMENT_BODY,
            observed_at,
            hebrew_name="משרד האוצר",
            aliases=("Ministry of Finance",),
            geography=("IL",),
            identifiers=(ExternalIdentifier("registry-source", "il.mof"),),
        ),
        _entity(
            "regulator.isa",
            "Israel Securities Authority",
            KnowledgeEntityType.REGULATOR,
            observed_at,
            hebrew_name="רשות ניירות ערך",
            aliases=("ISA",),
            geography=("IL",),
            identifiers=(ExternalIdentifier("registry-source", "il.isa"),),
        ),
        _entity(
            ...
            KnowledgeEntityType.REGULATOR,
            observed_at,
            hebrew_name="רשות התחרות",
            geography=("IL",),
            identifiers=(ExternalIdentifier("registry-source", "il.competition"),),
        ),
        _entity(
            "government.knesset",
            "Knesset",
            ...
            observed_at,
            hebrew_name="הכנסת",
            aliases=("Israeli Parliament",),
            geography=("IL",),
            identifiers=(ExternalIdentifier("registry-source", "il.knesset"),),
        ),
        _entity(
            "government.tax_authority",
            "Israel Tax Authority",
            KnowledgeEntityType.GOVERNMENT_BODY,
            observed_at,
            hebrew_name="רשות המסים בישראל",
            geography=("IL",),
            identifiers=(ExternalIdentifier("registry-source", "il.tax"),),
        ),
        _entity(
            "government.energy",
            ...
            KnowledgeEntityType.GOVERNMENT_BODY,
            observed_at,
            hebrew_name="משרד האנרגיה והתשתיות",
            geography=("IL",),
        ),
        _entity(
            "government.housing",
            ...
            KnowledgeEntityType.GOVERNMENT_BODY,
            observed_at,
            hebrew_name="משרד הבינוי והשיכון",
            geography=("IL",),
        ),
    ]
    sector_names = {
